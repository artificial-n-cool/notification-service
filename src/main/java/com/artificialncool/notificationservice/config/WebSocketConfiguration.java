package com.artificialncool.notificationservice.config;
...
public class WebSocketConfiguration implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        registry.setApplicationDestinationPrefixes("/socket-subscriber") // Prefiks koji koji se koristi za mapiranje svih poruka.
                ...
                .enableSimpleBroker("/socket-publisher/Guest_hostAnsweredReservation","/socket-publisher/Host_createdReservation","/scoket-publisher/Host_cancelledReservation" +
                                                    "/socket-publisher/Host_stayBeenRated", "/scoket-publisher/Host_hostBeenRated", "/socket-publisher/Host_automaticAcceptance" ); // Definisanje topic-a (ruta) na koje klijenti mogu da se pretplate.
